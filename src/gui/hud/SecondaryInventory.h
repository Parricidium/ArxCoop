...
public:
	...
	void dropEntity();
	//! ArxCoop: move an item of the player's inventory into the open container (shift+click): sold to a shop, stored in a chest; false if not moved
	bool quickPutEntity(Entity * item);
