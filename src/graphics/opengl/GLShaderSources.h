...
)glsl" R"glsl(				vec3 halfway = normalize(toLight + view);
...
constexpr const char * post_trace_frag = R"glsl(// ArxModern traced lighting (built with the "#version 430" / ARX_RT prelude, rt_common.glsl
...
constexpr const char * post_trace_blur_frag = R"glsl(#version 130
